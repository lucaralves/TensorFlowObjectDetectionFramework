...
#
def trainSSDMobNet(numSteps, warmupSteps, learningRateBase,
                   warmupLearningRate, checkpointMaxToKeep, checkpointFrequency):
...
trainSSDMobNet(numSteps=200, warmupSteps=100, learningRateBase=0.03, warmupLearningRate=0.007,
               checkpointMaxToKeep=10, checkpointFrequency=100)
saveLastCheckPoint()